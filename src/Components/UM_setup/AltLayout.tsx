        ...
        <div>
            ...
            >
                <Menu
                    ...
                    style={{ width: 250 }}
                    onClick={({ key }) => {
                        if (key === '3') navigate('/dashboard/usersetupuser');
                        else if (key === '4') navigate('/dashboard/userroless');
                        else if (key === '1') navigate('/dashboard/apicruduse');
                        else if (key === '2') navigate('/dashboard/apicall');
                    }}
                />
            </Drawer>
